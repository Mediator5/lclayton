...
const SERVICES = [
  {
    ...
    body: "For federal employees, reviewing the various types of employment benefits offered by the federal government can be confusing. At L. Clayton Services LLC, we will work with you to understand which retirement, financial planning, and investment strategies fit your needs. Whether your questions are regarding FERS, FEGLI, TSP, CSRS, or any other acronym, we are well-versed in your options and ready to help.",
