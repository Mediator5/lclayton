...
const CARDS = [
    {
        ...
        title: "About Us",
        href: "/about",
        body: "At L. Clayton Services LLC, we understand that you're entrusting us with significant aspects of your life. We take that responsibility seriously and are dedicated to getting everything right — from the very big to the very small.",
        cta: "Learn More",
        icon: (
